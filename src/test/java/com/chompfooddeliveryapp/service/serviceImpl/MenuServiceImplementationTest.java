...
class MenuServiceImplementationTest {
    ...
    void testAddMenuItem() {
        ...
        menuItem.setDescription("The characteristics of someone or something");
        menuItem.setId(123L);
        ...
        menuItem1.setDescription("The characteristics of someone or something");
        ...
        assertEquals("MenuItem(id=123, name=Name, image=Image, description=The characteristics of someone or something,"
                + " price=1, category=BURGER, dateCreated=1970-01-01 01:00:00.0)", menuItem1.toString());
    ...
    void testDeleteMenuItemById() {
        doNothing().when(this.menuItemRepository).deleteById((Long) any());
        this.menuServiceImplementation.deleteMenuItemById(123L);
        verify(this.menuItemRepository).deleteById((Long) any());
        assertTrue(this.menuServiceImplementation.getAllMenuItems().isEmpty());
    }

    @Test
    void testDeleteMenuItemById2() {
        doThrow(new MenuNotFoundException("An error occurred")).when(this.menuItemRepository).deleteById((Long) any());
